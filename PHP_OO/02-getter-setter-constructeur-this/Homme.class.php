...
// echo $homme -> prenom; // Même problème pour l'affichage que pour l'affectation
...
Commentaires : 
    Pourquoi faire des getters et des setters ?
        - Le PHP est un langage qui ne type pas ses variables. Il faut systématiquement contrôler l'intégrité des données renseignées. 
        - Donc utiliser la visibilité PRIVATE est une très bonne contrainte. Tout développeur devra OBLIGATOIREMENT passer par le setter pour affecter une valeur, et donc par les contrôles !
