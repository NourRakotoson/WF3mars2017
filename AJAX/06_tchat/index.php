...
<html>
    ...
    <body>
        ...
        <script>
            // mise en place d'un évènement sur la validation du formulaire
            document.getElementById("form").addEventListener("submit", function(event) {
                event.preventDefault(); // on bloque la soumission du form (pour éviter le rechargement de la page)
                ...
                xhttp.onreadystatechange = function() {
                    if(xhttp.readyState == 4 && xhttp.status == 200) {
                        ...
                        if(obj.pseudo == 'disponible') {
                            ...
                            // on le redirige vers dialogue.php 
                            window.location.href = 'dialogue.php'; // les .location cache les erreurs
                        }
                    }
                }
