<?php
/*
    1 - Afficher dans une table HTML la liste des restaurants avec les champs nom et téléphone, et un champ supplémentaires "autres infos" avec un lien qui permet d'afficher le détail de chaque contact. 
...
$contenu .= '<h1>Liste restaurants</h1>
			 <table border="1">';
		$contenu .= '<tr>
						<th>Nom</th>
						<th>Téléphone</th>
...
if(isset($_GET['id_restaurant'])){
	...
	if (!empty($restaurant)) {
		...
		$contenu .= '<p>Type de restaurant : '. $restaurant['type'] .'</p>';
