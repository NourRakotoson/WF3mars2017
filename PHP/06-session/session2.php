...
session_start(); // lorsque j'effectue un session_start(), la session n'est pas recréée car elle existe déjà grâce au session_start() lancée dans le fichier session1.php 
