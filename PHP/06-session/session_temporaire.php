<?php
// Contexte: souvent sur les sites bancaires, vous êtes déconnecté automatiquement au bout de 10 minutes d'activité. 
...
if(isset($_SESSION['temps']) && isset($_SESSION['limite'])) {
    ...
    if (time() > ($_SESSION['temps'] + $_SESSION['limite'])){
        ...
        echo '<hr> Votre session a expiré, vous êtes déconnecté(e) <hr>';
    } else {
    ...
    echo '<hr> Vous êtes connecté(e) <hr>';
}