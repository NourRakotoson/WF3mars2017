...
// II. Connexion à la BDD et le traitement du post:
...
if(!empty($_POST)) {
    ...
    // Pour l'exemple, on va injecter dans le champ message, le code suivant:
    ...
    // 1 - Nous allons faire une 1ère requête qui n'est pas protégée par les injections et qui n'acceptent pas les apostrophes : 
    ...
    // Pour se prémunir des injections SQL et pouvoir mettre des apostrophes (qui cassent la commande), nous pouvons faire une requête préparée : 
